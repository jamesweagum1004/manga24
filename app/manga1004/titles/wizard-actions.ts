...
export async function createTitleWizardAction(_state: QuickTitleState, formData: FormData): Promise<QuickTitleState> {
  ...
  try {
    const id = await createDbTitle({ canonicalSlug, originalTitle: value.originalTitle, authorName: value.authorName, originalLanguage: value.originalLanguage, format: value.format, contentRating: value.contentRating, publicationStatus: value.publicationStatus, enTitle: value.originalTitle, enSlug: canonicalSlug, enDescription: value.description, esTitle: value.originalTitle, esSlug: canonicalSlug, esDescription: value.description, enSeoTitle: "", enSeoDescription: "", enSeoKeywords: "", esSeoTitle: "", esSeoDescription: "", esSeoKeywords: "", tags: value.tags });
